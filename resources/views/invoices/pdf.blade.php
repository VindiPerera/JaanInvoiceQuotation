...
<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
    <tr>
        <td width="58%" style="vertical-align:top;padding-right:24px;">
            ...
            <div style="font-size:9pt;color:#333;margin-bottom:2px;">{{ $invoice->customer_address }}</div>
            @endif
            @if($invoice->customer_contact)
            <div style="font-size:9pt;color:#333;">{{ $invoice->customer_contact }}</div>
            @endif
        </td>
...
<table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td width="60%"></td>
        <td style="padding:5px 8px;font-size:9pt;border-bottom:1px dashed #aaa;">Subtotal</td>
        <td style="padding:5px 8px;text-align:right;font-size:9pt;border-bottom:1px dashed #aaa;width:96px;">
            {{ number_format((float)$invoice->subtotal) }}
        </td>
    </tr>
    <tr>
        <td></td>
        <td style="padding:5px 8px;font-size:9pt;border-bottom:1px dashed #aaa;">Tax</td>
        <td style="padding:5px 8px;text-align:right;font-size:9pt;border-bottom:1px dashed #aaa;">
    ...
    <tr>
        ...
        <td style="padding:8px 8px;font-size:9.5pt;font-weight:bold;
                   border-top:1px solid #000;border-bottom:3px double #000;">TOTAL (LKR)</td>
        <td style="padding:8px 8px;text-align:right;font-size:13pt;font-weight:bold;
                   white-space:nowrap;border-top:1px solid #000;border-bottom:3px double #000;">
    ...
    <tr>
        <td></td>
        <td style="padding:5px 8px;font-size:9pt;border-bottom:1px dashed #aaa;">Amount Paid</td>
        <td style="padding:5px 8px;text-align:right;font-size:9pt;border-bottom:1px dashed #aaa;">
    ...
    <tr>
        <td></td>
        <td style="padding:7px 8px;font-size:9.5pt;font-weight:bold;border-bottom:1px solid #000;">Balance Due (LKR)</td>
        <td style="padding:7px 8px;text-align:right;font-size:11pt;font-weight:bold;border-bottom:1px solid #000;">
...
<hr class="rule">
<table width="100%" cellpadding="0" cellspacing="0" style="font-size:9pt;line-height:1.9;margin-bottom:8px;">
    <tr>
